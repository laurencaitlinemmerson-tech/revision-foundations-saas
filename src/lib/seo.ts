...
export const siteUrl =
  process.env.NEXT_PUBLIC_SITE_URL || 'https://www.nurselab.co.uk';

// Default SEO configuration
export const defaultSEO = {
  siteName: 'The Nurse Lab',
  title: 'The Nurse Lab | The calm revision system for UK nursing students',
  description:
    "Structured OSCE practice, core nursing quizzes, and placement-ready revision guides for UK student nurses, with children's nursing live now.",
  locale: 'en_GB',
  type: 'website',
} as const;
