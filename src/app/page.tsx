...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-cream">
      ...
      <section className="bg-cream pb-20 relative">
        <Testimonials />
        
        {/* NEW STYLED BUTTON: Placed to overlap slightly for that clean look */}
        <div className="flex justify-center -mt-16 mb-12 relative z-20">
          <Link 
            href="https://wa.me/447572650980" 
            target="_blank"
            className="inline-flex items-center gap-2 bg-white/80 backdrop-blur px-5 py-2 rounded-full text-sm font-medium border border-[var(--lavender)]/30 transition-all hover:bg-white hover:scale-105 active:scale-95 shadow-sm"
          >
            <Sparkles className="w-4 h-4 text-[var(--purple)]" />
