        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '80vh', padding: '24px' }}>
          <div style={{
            ...
            <p style={{ ...bodyText, fontSize: '15px', marginBottom: '32px' }}>
              Unlock the full OSCE tool to keep going — all stations, detailed checklists, and step-by-step guidance.
            </p>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
              <Link href="/pricing?product=osce" style={{
    ...
    <div style={{ background: cream, minHeight: '100vh' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '80vh', padding: '24px' }}>
        <div style={{
          ...
          <p style={sectionLabel}>OSCE Practice</p>
          <p style={{
            fontFamily: display,
