...
const hubItems: HubItem[] = [
  ...
  },
  {
    ...
    description: 'Site selection, needle choice, step-by-step technique, pain minimisation and OSCE tips for paediatric IM and SC injections.',
  ...
  },
  {
    ...
    description: 'How to insert and confirm NG tube placement — NEX measurement, pH testing, why a 20–60ml syringe matters, and what to do when placement is uncertain.',
    tags: ['Clinical Skills', 'OSCE', 'Paeds', 'Placement'],
    difficulty: 'Moderate' as const,
    isLocked: false,
