...
function HubCard({
  ...
  return (
    ...
    >
      ...
      {/* Special detailed card for all except medication cheat sheet */}
      {[
        'y1-professionalism-ethics',
        'y1-documentation',
        'y1-infection-control',
        'y1-anatomy-physiology',
        'theories-dev',
        '1', // Paeds Respiratory Assessment
        '2', // Sepsis 6 & Escalation
        '3', // Wound Care & Infection Control
        '5', // SBAR Handover Template
        '6', // IV Fluids & Vitals Red Flags
        '7', // NEWS2 Quick Guide
        '8', // Pressure Area Care Plan
        '9', // A-E Assessment Checklist
        '10', // End of Life Communication Phrases
        '11', // PEWS
        '12', // Y1 Growth & Development Milestones
        '13', // Y1 Paediatric Vital Signs by Age
        '14', // Y1 Family-Centred Care Principles
        '15', // Y1 Pain Assessment in Children
        '16', // Y1 Safeguarding Children Essentials
        '17', // Y1 Consent & Gillick Competence
        '19', // Y1 Immunisation Schedule UK
        '20', // Y1 Play & Distraction Techniques
        '21', // Y1 Communicating with Children
        '22', // Glossary of Terms
        '26', // Medication Abbreviations Guide
        '28', // 9 Rights of Medication Administration
      ].includes(item.id) && (
        <div className="text-left text-[var(--plum-dark)]/90 mb-3">
          <h4 className="font-bold text-[var(--plum)] mb-1">Key Principles</h4>
          <ul className="list-disc pl-5 mb-2">
            {/* Example content, should be customized per card in future */}
            ...
            {item.id === 'theories-dev' && <>
              <li><strong>Compare major theories:</strong> Piaget, Erikson, Bowlby, Vygotsky, and more.</li>
              <li><strong>Apply theory:</strong> Use developmental theory to inform patient care and communication.</li>
              <li><strong>Practical examples:</strong> Relate theory to real-life placement scenarios.</li>
            </>}
            {item.id === 'y1-infection-control' && <>
              <li><strong>Hand hygiene:</strong> Wash hands before and after patient contact.</li>
              <li><strong>PPE:</strong> Use gloves, aprons, and masks appropriately.</li>
              <li><strong>Aseptic technique:</strong> Prevent contamination during procedures.</li>
            </>}
            {item.id === 'y1-anatomy-physiology' && <>
              <li><strong>Know the systems:</strong> Learn the main body systems and their functions.</li>
              <li><strong>Clinical relevance:</strong> Relate anatomy to common conditions seen on placement.</li>
              <li><strong>Memory aids:</strong> Use mnemonics and diagrams to help recall.</li>
            </>}
            {/* Add more per card as needed */}
            {item.id === '1' && <>
              <li><strong>Inspection:</strong> Look for signs of respiratory distress.</li>
              <li><strong>Auscultation:</strong> Listen for abnormal breath sounds.</li>
              <li><strong>Escalation:</strong> Know when to seek help for red flags.</li>
            </>}
            {item.id === '2' && <>
              <li><strong>Early recognition:</strong> Identify sepsis signs quickly.</li>
              <li><strong>Sepsis 6:</strong> Follow the bundle for initial management.</li>
              <li><strong>Escalation:</strong> Know the pathway for urgent review.</li>
            </>}
            {item.id === '3' && <>
              <li><strong>Wound assessment:</strong> Identify wound type and infection risk.</li>
              <li><strong>Dressing selection:</strong> Choose the right dressing for the wound.</li>
              <li><strong>Documentation:</strong> Record wound care accurately.</li>
            </>}
            {item.id === '5' && <>
              <li><strong>SBAR structure:</strong> Situation, Background, Assessment, Recommendation.</li>
              <li><strong>Clear communication:</strong> Be concise and factual.</li>
              <li><strong>Escalation:</strong> Use SBAR to raise concerns.</li>
            </>}
            {item.id === '6' && <>
              <li><strong>Vital signs:</strong> Recognise abnormal values that need escalation.</li>
              <li><strong>Fluid balance:</strong> Monitor input and output carefully.</li>
              <li><strong>Documentation:</strong> Record all fluids and actions taken.</li>
            </>}
            {item.id === '7' && <>
              <li><strong>NEWS2 chart:</strong> Score each parameter accurately.</li>
              <li><strong>Response triggers:</strong> Know when to escalate based on score.</li>
              <li><strong>Practice cases:</strong> Use examples to build confidence.</li>
            </>}
            {item.id === '8' && <>
              <li><strong>Waterlow scoring:</strong> Assess risk for pressure ulcers.</li>
              <li><strong>SSKIN bundle:</strong> Implement prevention strategies.</li>
              <li><strong>Case studies:</strong> Learn from real-life examples.</li>
            </>}
            {item.id === '9' && <>
              <li><strong>ABCDE steps:</strong> Follow the systematic approach.</li>
              <li><strong>Pocket checklist:</strong> Use for quick reference.</li>
              <li><strong>Escalation:</strong> Know when and how to get help.</li>
            </>}
            {item.id === '10' && <>
              <li><strong>Compassionate phrases:</strong> Use frameworks for difficult conversations.</li>
              <li><strong>Cultural considerations:</strong> Be sensitive to family needs.</li>
              <li><strong>Self-care:</strong> Look after your own wellbeing.</li>
            </>}
            {item.id === '11' && <>
              <li><strong>PEWS scoring:</strong> Use age-appropriate charts.</li>
              <li><strong>Red flags:</strong> Recognise signs of deterioration.</li>
              <li><strong>Escalation:</strong> Know the process for urgent review.</li>
            </>}
            {item.id === '12' && <>
              <li><strong>Milestones:</strong> Know key developmental stages.</li>
              <li><strong>Red flags:</strong> Identify concerns early.</li>
              <li><strong>Documentation:</strong> Record findings clearly.</li>
            </>}
            {item.id === '13' && <>
              <li><strong>Normal ranges:</strong> Learn vital sign values by age.</li>
              <li><strong>Interpretation:</strong> Spot abnormal results.</li>
              <li><strong>Escalation:</strong> Know when to seek help.</li>
            </>}
            {item.id === '14' && <>
              <li><strong>Principles:</strong> Involve families in care decisions.</li>
              <li><strong>Cultural sensitivity:</strong> Respect family backgrounds.</li>
              <li><strong>Communication:</strong> Keep families informed.</li>
            </>}
            {item.id === '15' && <>
              <li><strong>Pain tools:</strong> Use age-appropriate scales.</li>
              <li><strong>Escalation:</strong> Act on severe or unrelieved pain.</li>
              <li><strong>Documentation:</strong> Record pain scores and actions.</li>
            </>}
            {item.id === '16' && <>
              <li><strong>Recognise abuse:</strong> Know the signs and symptoms.</li>
              <li><strong>Escalation:</strong> Follow safeguarding pathways.</li>
              <li><strong>Support:</strong> Use available resources for help.</li>
            </>}
            {item.id === '17' && <>
              <li><strong>Gillick competence:</strong> Assess understanding and maturity.</li>
              <li><strong>Fraser guidelines:</strong> Apply in practice.</li>
              <li><strong>Legal considerations:</strong> Know your responsibilities.</li>
            </>}
            {item.id === '19' && <>
              <li><strong>Schedule:</strong> Learn the UK immunisation timetable.</li>
              <li><strong>Catch-up:</strong> Know what to do if vaccines are missed.</li>
              <li><strong>Communication:</strong> Discuss vaccines confidently with families.</li>
            </>}
            {item.id === '20' && <>
              <li><strong>Play techniques:</strong> Use distraction for different ages.</li>
              <li><strong>Reduce anxiety:</strong> Support children during procedures.</li>
              <li><strong>Family involvement:</strong> Encourage parents to participate.</li>
            </>}
            {item.id === '21' && <>
              <li><strong>Adapt communication:</strong> Match approach to age and stage.</li>
              <li><strong>Build rapport:</strong> Use play and open questions.</li>
              <li><strong>Overcome barriers:</strong> Address shyness or language issues.</li>
            </>}
            {item.id === '22' && <>
              <li><strong>Quick definitions:</strong> Use for OSCEs and exams.</li>
              <li><strong>Abbreviations:</strong> Learn common terms and pitfalls.</li>
              <li><strong>Memory aids:</strong> Use mnemonics for revision.</li>
            </>}
            {item.id === '26' && <>
              <li><strong>Abbreviations:</strong> Know units, routes, and frequencies.</li>
              <li><strong>Red flags:</strong> Spot unsafe abbreviations.</li>
              <li><strong>Safe prescribing:</strong> Double-check unfamiliar terms.</li>
            </>}
            {item.id === '28' && <>
              <li><strong>9 Rights:</strong> Check each right before giving medication.</li>
              <li><strong>Worked examples:</strong> Practice with real scenarios.</li>
              <li><strong>Safety reminders:</strong> Never skip a check.</li>
            </>}
          </ul>
          <h4 className="font-bold text-[var(--plum)] mb-1 mt-3">Common Pitfalls</h4>
          <ul className="list-disc pl-5">
            {/* Example pitfalls, should be customized per card in future */}
            {item.id === 'y1-documentation' && <>
            ...
            {item.id === 'theories-dev' && <>
              <li>Confusing stages or theorists—use comparison tables.</li>
              <li>Applying theory rigidly—adapt to the patient context.</li>
            </>}
            {item.id === 'y1-infection-control' && <>
              <li>Skipping hand hygiene steps.</li>
              <li>Incorrect PPE use.</li>
              <li>Not reporting infection risks promptly.</li>
            </>}
            {item.id === 'y1-anatomy-physiology' && <>
              <li>Memorising without understanding clinical relevance.</li>
              <li>Overlooking less common systems (e.g., lymphatic).</li>
            </>}
            {item.id === '1' && <>
              <li>Missing subtle signs of distress.</li>
              <li>Not escalating abnormal findings.</li>
            </>}
            {item.id === '2' && <>
              <li>Delaying escalation for suspected sepsis.</li>
              <li>Not following the Sepsis 6 steps in order.</li>
            </>}
            {item.id === '3' && <>
              <li>Using the wrong dressing type.</li>
              <li>Not documenting wound changes.</li>
            </>}
            {item.id === '5' && <>
              <li>Missing key information in handover.</li>
              <li>Not using SBAR structure.</li>
            </>}
            {item.id === '6' && <>
              <li>Ignoring abnormal vital signs.</li>
              <li>Not recording all fluid inputs/outputs.</li>
            </>}
            {item.id === '7' && <>
              <li>Incorrectly scoring NEWS2 parameters.</li>
              <li>Not escalating high scores.</li>
            </>}
            {item.id === '8' && <>
              <li>Missing early signs of pressure damage.</li>
              <li>Not using the SSKIN bundle consistently.</li>
            </>}
            {item.id === '9' && <>
              <li>Skipping ABCDE steps.</li>
              <li>Not using the checklist in emergencies.</li>
            </>}
            {item.id === '10' && <>
              <li>Using jargon with families.</li>
              <li>Neglecting your own emotional needs.</li>
            </>}
            {item.id === '11' && <>
              <li>Not using the correct PEWS chart for age.</li>
              <li>Missing red flags for deterioration.</li>
            </>}
            {item.id === '12' && <>
              <li>Overlooking subtle milestone delays.</li>
              <li>Not documenting concerns clearly.</li>
            </>}
            {item.id === '13' && <>
              <li>Confusing normal ranges by age.</li>
              <li>Not escalating abnormal values.</li>
            </>}
            {item.id === '14' && <>
              <li>Not involving families in care decisions.</li>
              <li>Ignoring cultural differences.</li>
            </>}
            {item.id === '15' && <>
              <li>Using the wrong pain scale for age.</li>
              <li>Not acting on high pain scores.</li>
            </>}
            {item.id === '16' && <>
              <li>Missing subtle signs of abuse.</li>
              <li>Not following escalation pathways.</li>
            </>}
            {item.id === '17' && <>
              <li>Assuming all children can consent.</li>
              <li>Not documenting consent discussions.</li>
            </>}
            {item.id === '19' && <>
              <li>Forgetting catch-up schedules.</li>
              <li>Not discussing vaccine concerns with families.</li>
            </>}
            {item.id === '20' && <>
              <li>Using inappropriate play techniques for age.</li>
              <li>Not involving parents in distraction.</li>
            </>}
            {item.id === '21' && <>
              <li>Using adult language with young children.</li>
              <li>Not addressing communication barriers.</li>
            </>}
            {item.id === '22' && <>
              <li>Confusing similar abbreviations.</li>
              <li>Not using memory aids for revision.</li>
            </>}
            {item.id === '26' && <>
              <li>Using unsafe or outdated abbreviations.</li>
              <li>Not double-checking unfamiliar terms.</li>
            </>}
            {item.id === '28' && <>
              <li>Skipping any of the 9 Rights.</li>
              <li>Not practicing with real scenarios.</li>
            </>}
          </ul>
        </div>
      )}
