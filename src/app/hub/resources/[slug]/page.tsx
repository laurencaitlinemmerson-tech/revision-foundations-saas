    ...
    sections: [
      {
        ...
        content: [
          ...
          'Look for visible obstruction: secretions, vomit, blood, foreign body, swelling',
          'Listen for abnormal sounds: stridor (upper airway), gurgling, snoring',
          'Feel for air movement at mouth/nose',
          'Check for tracheal deviation or use of accessory neck muscles',
          'If obstructed: head tilt/chin lift, jaw thrust, suction, consider airway adjuncts (OPA/NPA)',
          'Consider C-spine injury in trauma—use jaw thrust only',
          'Call for help early if airway compromised',
          'Red flags: No breath sounds, paradoxical chest/abdominal movement, cyanosis',
        ],
      },
      {
        title: 'B - Breathing',
        ...
        content: [
          ...
          'Observe work of breathing: accessory muscles, recession, nasal flaring, tracheal tug',
          'Check chest expansion: equal and bilateral?',
          'Auscultate: air entry, added sounds (wheeze, crackles, absent breath sounds)',
          'Percuss for dullness (consolidation/effusion) or hyperresonance (pneumothorax)',
          'Look for signs of respiratory distress: tachypnoea, cyanosis, agitation/confusion',
          ...
          'Red flags: Silent chest, exhaustion, altered mental status, tracheal deviation',
        ],
      },
      {
        title: 'C - Circulation',
        ...
        content: [
          ...
          'Measure blood pressure (compare to baseline if possible)',
          'Assess capillary refill time (<2 seconds normal)',
          'Inspect skin colour, temperature, and moisture (pale, mottled, clammy?)',
          'Check peripheral pulses (volume, regularity)',
          'Assess temperature (core and peripheral)',
          'Monitor urine output (if catheterised or able to measure)',
          'Look for bleeding (visible and consider hidden sources: GI, retroperitoneal)',
          'Establish IV access if unwell, take bloods, consider IV fluids',
          'Red flags: Hypotension, tachycardia, cold peripheries, oliguria/anuria',
        ],
      },
      {
        title: 'D - Disability',
        ...
        content: [
          ...
          'Calculate GCS if reduced consciousness',
          'Check pupil size, symmetry, and reactivity to light',
          'Measure blood glucose (treat if <4mmol/L or >15mmol/L)',
          'Review drug chart: sedatives, opioids, insulin, antiepileptics?',
          'Look for signs of seizure activity or post-ictal state',
          'Consider causes: hypoxia, hypoglycaemia, opiates, head injury, stroke, infection',
          'Red flags: Unresponsive, new focal neurology, persistent hypoglycaemia',
        ],
      },
      {
        title: 'E - Exposure',
        ...
        content: [
          ...
          'Look for rashes, wounds, swelling, bruising, pressure sores',
          'Check behind/underneath patient (log roll if trauma suspected)',
          'Review observation charts, fluid balance, medication and notes for trends',
          'Keep patient warm after examination (prevent hypothermia)',
          'Red flags: Petechial/purpuric rash, rapidly spreading swelling, hypothermia',
        ],
      },
    ],
  },
