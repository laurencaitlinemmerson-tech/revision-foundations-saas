...
@media (max-width: 800px) {
  ...
  .dc-content-col:nth-child(n+3) { border-top: 0.5px solid var(--hairline-firm); }
  .dc-golden { grid-template-columns: 1fr 1fr; }
  .dc-golden-cell:nth-child(2) { border-right: none; }
  .dc-golden-cell:nth-child(n+3) { border-top: 0.5px solid var(--hairline-firm); }
  .dc-grid-2 { grid-template-columns: 1fr; }
  .dc-grid-2-col { border-right: none; border-bottom: 0.5px solid var(--hairline-firm); }
