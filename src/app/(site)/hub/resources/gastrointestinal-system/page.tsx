...
.gi-table td:first-child { font-weight: 400; color: #2C2A27; }
...
/* Step colour system */
.gi-letter-1 { color: #185FA5; }
.gi-badge-1 { background: #E6F1FB; color: #0C447C; }
.gi-letter-2 { color: #0F6E56; }
.gi-badge-2 { background: #E1F5EE; color: #085041; }
.gi-letter-3 { color: #993C1D; }
.gi-badge-3 { background: #FAECE7; color: #712B13; }
.gi-letter-4 { color: #534AB7; }
.gi-badge-4 { background: #EEEDFE; color: #3C3489; }
.gi-letter-5 { color: #5F5E5A; }
.gi-badge-5 { background: #F1EFE8; color: #444441; }
.gi-letter-6 { color: #8B5E3C; }
.gi-badge-6 { background: #F5EDE5; color: #6B4529; }
...
@media (max-width: 860px) {
  ...
  .gi-golden-cell { border-bottom: 0.5px solid rgba(0,0,0,0.12); }
  .gi-step { grid-template-columns: 1fr; }
  .gi-step-sidebar { flex-direction: row; align-items: center; gap: 12px; border-right: none; border-bottom: 0.5px solid rgba(0,0,0,0.1); padding-bottom: 16px; margin-bottom: 16px; padding-right: 0; }
  .gi-step-content { padding-left: 0; }
  .gi-content-grid { grid-template-columns: 1fr 1fr; }
  .gi-content-col { border-bottom: 0.5px solid rgba(0,0,0,0.1); }
  .gi-info-grid { grid-template-columns: 1fr 1fr; }
  .gi-info-cell { border-bottom: 0.5px solid rgba(0,0,0,0.1); }
  .gi-two-grid { grid-template-columns: 1fr; }
  .gi-two-cell { border-right: none; border-bottom: 0.5px solid rgba(0,0,0,0.1); }
