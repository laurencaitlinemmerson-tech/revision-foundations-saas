...
const RESOURCE = {
  ...
  title: 'Gastrointestinal System | Nursing Revision',
  description: 'Gut anatomy, digestion and absorption, paediatric GI conditions, abdominal assessment, and red flags for student nurses.',
} as const;
