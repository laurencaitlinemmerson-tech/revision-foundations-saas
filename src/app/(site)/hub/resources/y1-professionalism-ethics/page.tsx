...
.pe-back:hover { color: var(--ink-soft); }
...
/* Step colour system */
.pe-letter-1 { color: var(--blue-600); }
.pe-badge-1 { background: var(--blue-50); color: var(--blue-800); }
.pe-letter-2 { color: var(--teal-600); }
.pe-badge-2 { background: var(--teal-50); color: var(--teal-800); }
.pe-letter-3 { color: var(--coral-600); }
.pe-badge-3 { background: var(--coral-50); color: var(--coral-800); }
.pe-letter-4 { color: var(--purple-600); }
.pe-badge-4 { background: var(--purple-50); color: var(--purple-800); }
.pe-letter-5 { color: var(--gray-600); }
.pe-badge-5 { background: var(--surface-sunken); color: var(--gray-800); }
.pe-letter-6 { color: #8B5E3C; }
.pe-badge-6 { background: var(--surface-sunken); color: #6B4527; }
...
@media (max-width: 800px) {
  ...
  .pe-content-col:nth-child(n+3) { border-top: 0.5px solid var(--hairline-firm); }
  .pe-golden { grid-template-columns: 1fr 1fr; }
  .pe-golden-cell:nth-child(2) { border-right: none; }
  .pe-golden-cell:nth-child(n+3) { border-top: 0.5px solid var(--hairline-firm); }
  .pe-grid-2 { grid-template-columns: 1fr; }
  .pe-grid-2-col { border-right: none; border-bottom: 0.5px solid var(--hairline-firm); }
