...
.rn-back:hover { color: var(--ink-soft); }
...
.rn-table td:first-child { font-weight: 400; color: var(--ink-mid); }
...
/* Step colour system */
.rn-letter-1 { color: var(--blue-600); }
.rn-badge-1 { background: var(--blue-50); color: var(--blue-800); }
.rn-letter-2 { color: var(--teal-600); }
.rn-badge-2 { background: var(--teal-50); color: var(--teal-800); }
.rn-letter-3 { color: var(--coral-600); }
.rn-badge-3 { background: var(--coral-50); color: var(--coral-800); }
.rn-letter-4 { color: var(--purple-600); }
.rn-badge-4 { background: var(--purple-50); color: var(--purple-800); }
.rn-letter-5 { color: var(--gray-600); }
.rn-badge-5 { background: var(--surface-sunken); color: var(--gray-800); }
.rn-letter-6 { color: #8B5E3C; }
.rn-badge-6 { background: var(--surface-sunken); color: #6B4529; }

/* Responsive */
@media (max-width: 860px) {
  .rn-wrap { padding: 24px 20px 48px; }
  .rn-headline { font-size: 36px; }
  .rn-golden { grid-template-columns: 1fr 1fr; }
  .rn-golden-cell { border-bottom: 0.5px solid var(--hairline-firm); }
  .rn-step { grid-template-columns: 1fr; }
  .rn-step-sidebar { flex-direction: row; align-items: center; gap: 12px; border-right: none; border-bottom: 0.5px solid var(--hairline-firm); padding-bottom: 16px; margin-bottom: 16px; padding-right: 0; }
  .rn-step-content { padding-left: 0; }
  .rn-content-grid { grid-template-columns: 1fr 1fr; }
  .rn-content-col { border-bottom: 0.5px solid var(--hairline-firm); }
  .rn-info-grid { grid-template-columns: 1fr 1fr; }
  .rn-info-cell { border-bottom: 0.5px solid var(--hairline-firm); }
  .rn-two-grid { grid-template-columns: 1fr; }
  .rn-two-cell { border-right: none; border-bottom: 0.5px solid var(--hairline-firm); }
  ...
  return (
    <div className="rn-guide">
      ...
      <div className="rn-wrap">
        ...
        {/* Golden rules */}
        <KidneyDiagram caption="Cross-section of the kidney" />
