...
.ic-back:hover { color: var(--ink-soft); }
...
.ic-table td:first-child { font-weight: 400; color: var(--ink-mid); }
...
/* Step colour system */
.ic-num-1 { color: var(--blue-600); }
.ic-badge-1 { background: var(--blue-50); color: var(--blue-800); }
.ic-num-2 { color: var(--teal-600); }
.ic-badge-2 { background: var(--teal-50); color: var(--teal-800); }
.ic-num-3 { color: var(--coral-600); }
.ic-badge-3 { background: var(--coral-50); color: var(--coral-800); }
.ic-num-4 { color: var(--purple-600); }
.ic-badge-4 { background: var(--purple-50); color: var(--purple-800); }
.ic-num-5 { color: var(--gray-600); }
.ic-badge-5 { background: var(--surface-sunken); color: var(--gray-800); }
.ic-num-6 { color: #8B5E3C; }
.ic-badge-6 { background: var(--surface-sunken); color: #5C3D25; }
...
@media (max-width: 860px) {
  ...
  .ic-step-sidebar { flex-direction: row; align-items: center; gap: 12px; border-right: none; border-bottom: 0.5px solid var(--hairline-firm); padding-bottom: 16px; padding-right: 0; margin-bottom: 20px; }
  ...
  .ic-content-col:nth-child(n+3) { border-top: 0.5px solid var(--hairline-firm); }
  .ic-grid-2 { grid-template-columns: 1fr; }
  .ic-grid-2-col { border-right: none; border-bottom: 0.5px solid var(--hairline-firm); }
