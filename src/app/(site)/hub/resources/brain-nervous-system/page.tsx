...
.ns-back:hover { color: var(--ink-soft); }
...
.ns-table td:first-child { font-weight: 400; color: var(--ink-mid); }
...
/* Step colour system */
.ns-letter-1 { color: var(--blue-600); }
.ns-badge-1 { background: var(--blue-50); color: var(--blue-800); }
.ns-letter-2 { color: var(--teal-600); }
.ns-badge-2 { background: var(--teal-50); color: var(--teal-800); }
.ns-letter-3 { color: var(--coral-600); }
.ns-badge-3 { background: var(--coral-50); color: var(--coral-800); }
.ns-letter-4 { color: var(--purple-600); }
.ns-badge-4 { background: var(--purple-50); color: var(--purple-800); }
.ns-letter-5 { color: var(--gray-600); }
.ns-badge-5 { background: var(--surface-sunken); color: var(--gray-800); }
.ns-letter-6 { color: #8B5E3C; }
.ns-badge-6 { background: var(--surface-sunken); color: #6B4529; }

/* Responsive */
@media (max-width: 860px) {
  .ns-wrap { padding: 24px 20px 48px; }
  .ns-headline { font-size: 36px; }
  .ns-golden { grid-template-columns: 1fr 1fr; }
  .ns-golden-cell { border-bottom: 0.5px solid var(--hairline-firm); }
  .ns-step { grid-template-columns: 1fr; }
  .ns-step-sidebar { flex-direction: row; align-items: center; gap: 12px; border-right: none; border-bottom: 0.5px solid var(--hairline-firm); padding-bottom: 16px; margin-bottom: 16px; padding-right: 0; }
  .ns-step-content { padding-left: 0; }
  .ns-content-grid { grid-template-columns: 1fr 1fr; }
  .ns-content-col { border-bottom: 0.5px solid var(--hairline-firm); }
  .ns-info-grid { grid-template-columns: 1fr 1fr; }
  .ns-info-cell { border-bottom: 0.5px solid var(--hairline-firm); }
