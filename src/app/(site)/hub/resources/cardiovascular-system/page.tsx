...
.cv-back:hover { color: var(--ink-soft); }
...
.cv-table td:first-child { font-weight: 400; color: var(--ink-mid); }
...
/* Step colour system */
.cv-letter-1 { color: var(--blue-600); }
.cv-badge-1 { background: var(--blue-50); color: var(--blue-800); }
.cv-letter-2 { color: var(--teal-600); }
.cv-badge-2 { background: var(--teal-50); color: var(--teal-800); }
.cv-letter-3 { color: var(--coral-600); }
.cv-badge-3 { background: var(--coral-50); color: var(--coral-800); }
.cv-letter-4 { color: var(--purple-600); }
.cv-badge-4 { background: var(--purple-50); color: var(--purple-800); }
.cv-letter-5 { color: var(--gray-600); }
.cv-badge-5 { background: var(--surface-sunken); color: var(--gray-800); }
.cv-letter-6 { color: #8B5E3C; }
.cv-badge-6 { background: var(--surface-sunken); color: #6B4729; }
...
@media (max-width: 860px) {
  ...
  .cv-golden-cell:nth-child(1), .cv-golden-cell:nth-child(2) { border-bottom: 0.5px solid var(--hairline-firm); }
  ...
  .cv-content-col:nth-child(1), .cv-content-col:nth-child(2) { border-bottom: 0.5px solid var(--hairline-firm); }
  .cv-grid-2 { grid-template-columns: 1fr; }
  .cv-grid-2-cell { border-right: none; border-bottom: 0.5px solid var(--hairline-firm); }
  .cv-grid-2-cell:last-child { border-bottom: none; }
}

@media (max-width: 520px) {
  .cv-golden { grid-template-columns: 1fr; }
  .cv-golden-cell { border-right: none; border-bottom: 0.5px solid var(--hairline-firm); }
  .cv-golden-cell:last-child { border-bottom: none; }
  .cv-content-grid { grid-template-columns: 1fr; }
  .cv-content-col { border-right: none; border-bottom: 0.5px solid var(--hairline-firm); }
