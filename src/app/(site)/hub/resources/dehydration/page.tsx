...
.dh-back:hover { color: var(--ink-soft); }
...
.dh-table td:first-child { font-weight: 400; color: var(--ink-mid); }
...
/* Step colour system */
.dh-letter-1 { color: var(--blue-600); }
.dh-badge-1 { background: var(--blue-50); color: var(--blue-800); }
.dh-letter-2 { color: var(--teal-600); }
.dh-badge-2 { background: var(--teal-50); color: var(--teal-800); }
.dh-letter-3 { color: var(--coral-600); }
.dh-badge-3 { background: var(--coral-50); color: var(--coral-800); }
.dh-letter-4 { color: var(--purple-600); }
.dh-badge-4 { background: var(--purple-50); color: var(--purple-800); }
.dh-letter-5 { color: var(--gray-600); }
.dh-badge-5 { background: var(--surface-sunken); color: var(--gray-800); }
.dh-letter-6 { color: #8B5E3C; }
.dh-badge-6 { background: var(--surface-sunken); color: #6B4529; }
...
@media (max-width: 860px) {
  ...
  .dh-golden-cell { border-bottom: 0.5px solid var(--hairline-firm); }
  .dh-step { grid-template-columns: 1fr; }
  .dh-step-sidebar { flex-direction: row; align-items: center; gap: 12px; border-right: none; border-bottom: 0.5px solid var(--hairline-firm); padding-bottom: 16px; margin-bottom: 16px; padding-right: 0; }
  .dh-step-content { padding-left: 0; }
  .dh-content-grid { grid-template-columns: 1fr 1fr; }
  .dh-content-col { border-bottom: 0.5px solid var(--hairline-firm); }
  .dh-info-grid { grid-template-columns: 1fr 1fr; }
  .dh-info-cell { border-bottom: 0.5px solid var(--hairline-firm); }
  .dh-two-grid { grid-template-columns: 1fr; }
  .dh-two-cell { border-right: none; border-bottom: 0.5px solid var(--hairline-firm); }
