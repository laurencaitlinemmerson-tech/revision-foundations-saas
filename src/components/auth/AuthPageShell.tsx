    ...
    <div className="min-h-screen flex flex-col bg-[var(--cream)] text-[var(--charcoal)] transition-colors duration-300">
      <main className="flex-1 flex flex-col items-center justify-center py-[120px] px-6 pb-20 max-md:py-[100px] max-md:px-4 max-md:pb-[60px]">
        <div className="text-center mb-10 max-w-[400px]">
          <p className="text-[10px] tracking-[0.22em] uppercase text-[var(--ink-faint)] mb-4">
        ...
        <div className="w-full max-w-[400px]">
          ...
          <div className="mt-6 text-center">
            <p className="text-[11px] text-[var(--ink-faint)] leading-[1.6] m-0">
              {finePrint}{' '}
        ...
        <div className="mt-9 text-center">
          <Link href="/" className="font-display text-sm text-[var(--ink-faint)] tracking-[-0.01em] transition-colors hover:text-[var(--ink-faint)] dark:hover:text-[var(--text-muted)]">
            The Nurse Lab
          </Link>
        </div>
      </main>
