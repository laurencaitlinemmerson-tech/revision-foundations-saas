...
export default function LoadingSpinner({ size = 'md', text }: LoadingSpinnerProps) {
  ...
  return (
    <div 
      ...
      aria-live="polite"
    >
      <div className={`relative ${sizeClasses[size]} h-[2px] overflow-hidden rounded-full bg-[rgba(26,24,21,0.08)]`}>
        <div className="absolute inset-y-0 left-0 w-1/2 animate-pulse rounded-full bg-[var(--espresso)]" />
      </div>
      {text && (
