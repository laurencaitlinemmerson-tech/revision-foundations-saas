    ...
    <section>
      <div className="flex flex-col gap-4 border-t border-[rgba(26,24,21,0.08)] pt-4 md:flex-row md:items-end md:justify-between">
        <div className="max-w-2xl">
          ...
          <h2 className="mt-3 font-display text-[clamp(2rem,3vw,2.8rem)] leading-[1.02] tracking-[-0.02em] text-[var(--espresso)]">
            {title}
          </h2>
          {description ? (
      ...
      >
        {items.map((item, index) => (
          <motion.div
            ...
            className="min-w-[85%] snap-start sm:min-w-[420px] lg:min-w-[360px]"
          >
            {item}
          </motion.div>
        ))}
