...
const faqs: FAQItem[] = [
  {
    ...
    answer: "You get lifetime access to the tool you buy, including the full set of stations or quiz topics, your dashboard access, and any new resources added to that product over time.",
  },
  {
  ...
  },
  {
    ...
    answer: "Yes. The Nurse Lab is mobile-friendly, so you can revise on placement, on the bus, or wherever you have a spare few minutes.",
  },
  {
    question: "Is there a subscription or recurring payment?",
    answer: "No. It is a one-time payment for lifetime access, with no recurring charges.",
  },
  {
